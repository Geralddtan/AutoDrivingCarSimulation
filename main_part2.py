...
if __name__ == "__main__":
    """
    Main code to run part 2
    - Reads in input txt file
    - Initialises Vehicles, Field, VehicleManager
    - Checks for any vehicle collision
    """

    try:
        main = Main()
        file_path = input("Please Input your txt file name: ")
        user_input = main.read_txt_file(file_path) #Process user txt input
        ...
        # Process each vehicle and add vehicle to the vehicle manager
        counter = 1
        for i in range(0, num_cars):
            ...
            # Check if vehicle is initialised outside of field boundaries
        ...
        #Main code to check for collision
